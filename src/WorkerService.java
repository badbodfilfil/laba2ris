...
public class WorkerService {
    ...
    public SOAPEnvelope createSOAPResponse(String fileName, SOAPEnvelope resp) throws SOAPException, ParserConfigurationException, IOException, SAXException {
        ...
        Document document = builder.parse("E://" + fileName);
    ...
    public void workerService(SOAPEnvelope req, SOAPEnvelope resp) throws Exception, TransformerException, IOException {
